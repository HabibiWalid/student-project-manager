...
**Status:** Phase 1 (Foundation) complete — config, DB models, argon2 auth,
signed session cookie, and server-side role gating. Login works.
...
rendering (no raw Jinja markup leaks; generic 简体中文 error shown), and
